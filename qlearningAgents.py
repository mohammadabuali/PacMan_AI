...
class QLearningAgent(ReinforcementAgent):
    ...
    def getPolicy(self, state):
        ...
        actions = [action for action in legal_actions if self.getQValue(state, action) == max_value]
    ...
    def update(self, state, action, nextState, reward):
        ...
        self._q_val[(state, action)] += self.alpha * (reward + self.discount * self.getValue(nextState) - q_value)
